...
import { DeleteTransaction, UpdateTransactions } from './transactions/buttons';
  ...
  return (
    <div className='overflow-x-auto bg-white rounded-lg shadow'>
      <table className='min-w-full table-auto'>
        ...
        <tbody className='bg-white divide-y divide-gray-200 [&_td]:text-center capitalize'>
          {transactions.map((transaction) => (
            <tr key={transaction.id}>
              ...
              <div className='flex justify-end gap-3 place-items-center'>
                <UpdateTransactions id={transaction.id} />
